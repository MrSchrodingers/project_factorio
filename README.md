...
**Cortex Research Architecture v0.1 — F2-F4C concluiu functional accept real. A cadeia v3
selecionou burner-inserter + coal por capability runtime, produziu 13 iron plates e foi commitada
após todas as hard postconditions. O processor terminou no_fuel: sustentabilidade contínua não foi
provada. F2-G fecha options + runner independence; F3 e continuous authority seguem bloqueadas.**
